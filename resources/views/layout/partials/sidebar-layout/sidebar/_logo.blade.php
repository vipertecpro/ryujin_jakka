...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ getGlobalSetting('logo') ? getGlobalSetting('logo') : image('logos/default-dark.svg') }}" class="h-25px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ getGlobalSetting('favicon') ? getGlobalSetting('favicon') : image('logos/default-small.svg') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
