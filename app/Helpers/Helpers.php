...
if (!function_exists('globalSettings')) {
     ...
     * @return string
     */
    function getGlobalSetting($meta_key): mixed
    {
        $getMetaValue = GlobalSetting::where('key', $meta_key)->first();
        if ($getMetaValue !== null) {
            if ($getMetaValue->type === 'FILE') {
                ...
                return url('storage/media/' . $getMetaValue->value);
            } else {
                return $getMetaValue->value;
            }
        }
        return null;
    }
