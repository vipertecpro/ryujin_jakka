...
class RolesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function (Role $role) {
                return view('pages.apps.roles.columns._actions', compact('role'));
            })
            ->setRowId('id');
    }
    ...
    {
        $canExport = Auth::user()->hasPermissionTo('export roles management');
        $export = [];
        if ($canExport === true) {
            $export = [
                [
        ...
        return $this->builder()
            ...
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/roles/columns/_draw-scripts.js')) . "}");
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('created_at')->addClass('border w-200px'),
        ];
    }
